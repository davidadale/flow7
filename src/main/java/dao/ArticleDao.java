...
public class ArticleDao {
    ...
    public boolean postArticle(String username, ArticleDto articleDto) {
        ...
        Query query = entityManager.createQuery("SELECT x FROM DemoUser x WHERE username = :usernameParam");
        DemoUser user = (DemoUser) query.setParameter("usernameParam", username).getSingleResult();
