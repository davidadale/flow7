...
public class UserDao {
    ...
    public boolean isUserAndPasswordValid(String username, String password) {
        ...
        if (username != null && password != null) {
            ...
            TypedQuery<DemoUser> q = entityManager.createQuery("SELECT x FROM DemoUser x WHERE username = :usernameParam", DemoUser.class);
            DemoUser user = getSingleResult(q.setParameter("usernameParam", username));
