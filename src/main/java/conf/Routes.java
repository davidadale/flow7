...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {  
        ...
        if (!ninjaProperties.isProd()) {
            ...
            router.POST().route("/domain").with(ContentController.class, "changeDomain");
            router.POST().route("/domain/clear").with(ContentController.class,"clearDomain");
        }
        ...
        router.GET().route("/dashboard").with(ContentController.class,"dashboard");
        router.GET().route("/users").with(UserController.class,"list");
        ...
        ///////////////////////////////////////////////////////////////////////
        router.GET().route("/libraries/.*").with(ContentController.class,"libraries");
        router.GET().route("/.*").with(ContentController.class, "render");
    }
